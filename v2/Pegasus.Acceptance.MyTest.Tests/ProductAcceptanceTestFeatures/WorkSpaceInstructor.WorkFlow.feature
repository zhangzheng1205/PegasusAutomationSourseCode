...
When I select the "MyTest" tab 
And I click on the "Create New Test" link in Manage Your Tests and created Test using "Essay" question
Then I should see the successfull message "Test saved successfully." in MyTest tab
...
When I select the "Course Materials" tab
And I navigate to the "Add from Library" tab
Then I should be on the "Course Materials" page
