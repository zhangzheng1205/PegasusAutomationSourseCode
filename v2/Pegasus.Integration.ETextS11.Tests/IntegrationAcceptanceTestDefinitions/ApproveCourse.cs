    ...
    IntegrationAcceptanceTestDefinitions
{
    ...
    public class ApproveCourse : PegasusBaseTestFixture
    {
        ...
        {
            // Verify Course Search In CourseSpace
            Logger.LogMethodEntry("ApproveCourse", "CheckSearchedCourseInCoreSpace",
            base.isTakeScreenShotDuringEntryExit);
            ...
            String optionName)
        {
            ...
            Logger.LogMethodEntry("ApproveCourse", "ClickCMenuCourseOptionInCourseSpace",
                base.isTakeScreenShotDuringEntryExit);
            // Click on course cmenu in course space
            new ListCoursesPage().ClickCourseCMenuOption(optionName);
            Logger.LogMethodExit("ApproveCourse", "ClickCMenuCourseOptionInCourseSpace",
                base.isTakeScreenShotDuringEntryExit);
        }
