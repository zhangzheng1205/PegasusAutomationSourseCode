    ...
    ProductAcceptanceTestDefinitions
{
    ...
    public class CourseCopy : PegasusBaseTestFixture
    {
            ...
            (Course.CourseTypeEnum courseTypeEnum)
        {
            ...
            new ManageCoursesPage().ClickCourseCMenuOption
             (CourseCopyResource.
             CourseCopy_CopyasMasterCourse_CMenu_CTC_Option_Name);
        ...
        /// </summary>
        [Then(@"I should see the column headers in manage users frame")]
        public void VerifyTheColumnHeadersInManageUsersFrame()
        {
            //Verify The Column Headers In Manage Users Frame
            Logger.LogMethodEntry("CourseCopy",
            ...
            Logger.LogAssertion("VerifyTheColumnHeadersInManageUsersFrame",
                ScenarioContext.Current.ScenarioInfo.Title, () =>
                    Assert.AreEqual(CourseCopyResource.CourseCopy_Column_Headers_Expected_Value,
