...
this.ScenarioSetup(scenarioInfo);
#line 31
testRunner.Then("I should see the \"Unread Comments (1)\" channels in \'Todays view\' page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 32
testRunner.And("I should see the alert count updated as \"1\" in \"Unread Comments (1)\" channel", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
