...
namespace Pegasus.Automation.DataTransferObjects
{
    ...
    public class Course : BaseEntityObject
    {
        ...
        public enum CourseTypeEnum
        {
            ...
            AmpWSCourse = 56,
            AmpProgramCourse = 57,
            AmpInstructorCourse = 58,
            BBCourse = 59,
            //SSRS Course            
            HED5xPMC = 60,
            WVUCourse = 61,
            CanvasKioskCourse = 62,
            D2LKioskCourse = 63,
            MoodleKioskCourse = 64,
            D2LDirectCourse = 65,
            MoodleDirectCourse = 66,
            MyItLabSIM5AnotherWorkSpaceMasterCourse=67,
            ExistingCourseForPublish=68,
            ExistingPublishedCourse=69,
            MasterLibrarySameProduct=70,
            MasterLibraryDifferentProduct=71,
            MyITLabOffice2013ProgramCourseCreation=72,
            MyITLabForOffice2013MasterCourseCreation=73,
            RegMySpanishLabMaster=74,
            CanvasDirectCourse = 75,
            RegWLMasterCourse = 76,
            BadgingCourse = 77,
            BadgingCourseProgram = 78,
            eTextCourse=79,
