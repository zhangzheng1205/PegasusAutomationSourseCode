...
namespace Pegasus.Automation.DataTransferObjects
{
    ...
    public class Activity : BaseEntityObject
    {
        ...
        public enum ActivityTypeEnum
        {
            ...
            RegCSSAMActivity=52,
            RegCSHighestScoreActivity =53,
            RegCSLowestScoreActivity=54,
            ...
            RegSimpleAssign =65,          
            RegWLSubmissionActivity = 66,
            RegLinkAsset = 67,
            RegEtextLinkAsset = 68,
            RegFileAsset=69,
            RegMultipleFileAsset=70,
            RegPageAsset =71,
            ...
            RegPastDueAcceptAssignment = 91,
            RegPastDueDeclineAssignment = 92
        }
