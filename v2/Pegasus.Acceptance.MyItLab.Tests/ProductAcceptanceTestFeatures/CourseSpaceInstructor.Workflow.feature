...
When I click on "Return to Manage Course Materials" button in 'Course Materials Wizard' lightbox
...
#And I click on "Return to Manage Course Materials" button in 'Add from Library' lightbox
