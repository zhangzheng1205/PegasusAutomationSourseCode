...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Validate open button functionallity for MyITLabOffice2013Program as CsSmsStudent")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "CourseSpaceStudentGlobalHomePage")]
        public virtual void ValidateOpenButtonFunctionallityForMyITLabOffice2013ProgramAsCsSmsStudent()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validate open button functionallity for MyITLabOffice2013Program as CsSmsStudent", ((string[])(null)));
#line 105
this.ScenarioSetup(scenarioInfo);
#line 106
testRunner.When("I click on Open button of \"MyITLabOffice2013Program\" as \"CsSmsStudent\" user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 107
testRunner.Then("I should be displayed with \"MyITLabOffice2013Program\" course information for \"CsS" +
                    "msStudent\" user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
