...
#MyItLabProgramCourse
#Test Case Id :
Scenario: Cmenu SimpleAssign with due date for CurrentDate 354345345
#When I navigate to "Assignment Calendar" tab
#Then I should be on the "Calendar" page
...
#---------------------------------------------------------------------------------------------------------------------------------------------------
									# Drag drop asset for current date and Future date #
#---------------------------------------------------------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------------------------------------------------------
									# Cmenu assign the asset to current date, Previous date and Future date #
#---------------------------------------------------------------------------------------------------------------------------------------------------
...
Then I should see the "RegSimpleCmenuAssignCurrentDate" activity of behavioral mode "SkillBased" assigned by 'CMenu' in "Current date" of day view 
...
Then I should see the "RegPastDueCmenuAssignment" activity of behavioral mode "SkillBased" assigned by 'CMenu' in "PastDue date" of day view 
#When I click on "Back to Month" link in Calendar frame
Then I should be on the "Calendar" page
...
#Purpose : Validate Advanced Calendar view as SMS Instructor
#MyItLabProgramCourse
#Test Case Id :
Scenario: Validate the Advanced Calendar view as SMS Instructor
When I navigate to "Assignment Calendar" tab
Then I should be on the "Calendar" page
And I should see the "RegSimpleCmenuAssignCurrentDate" activity of behavioral mode "SkillBased" assigned by 'CMenu' in "Current date" of day view 
When I click on "Advanced Calendar" option in calender frame of "Calendar" page
Then I should be displayed with "Assignments" option in "Advanced Calendar" of "Calendar" page
And I should be displayed with "Calendar Widget" option in "Advanced Calendar" of "Calendar" page
And I should be displayed with "Calendar Viewby" option in "Advanced Calendar" of "Calendar" page
