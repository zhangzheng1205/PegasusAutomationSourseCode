        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "PEGASUS-10477: Enabling the Skills & Standards & adding the skill framework for t" +
                            "he course")))
            {
                Pegasus.Integration.DigitalPath.Rumba.Tests.IntegrationAcceptanceTestFeatures.PEGASUS_10477EnablingTheSkillsStandardsAddingTheSkillFrameworkForTheCourseFeature.FeatureSetup(null);
            }
        }
