    ...
    public class GraderFeedbackPage : BasePage
    {
        ...
        public Boolean ValidateTheMessageOnPopupPage(string message)
        {
            ...
            try
            {
                ...
                IsTrue = base.IsElementContainsTextById(GraderFeedbackResource.GraderFeedbackResource_Page_Table_Id_Locator, message);
            }
            //Exception Handling
            catch (Exception e)
            {
        ...
        {
            //To Validate The Message On the Copy as Section Popup Page
            logger.LogMethodEntry("GraderFeedbackPage", "ValidateTheMessageOnTestResultPopupPage",
            base.IsTakeScreenShotDuringEntryExit);
            ...
            logger.LogMethodExit("PresentationPage", "ValidateTheMessageOnTestResultPopupPage",
            base.IsTakeScreenShotDuringEntryExit);
        ...
        public int GetScorefromTestResult(String popupName)
        {
            ...
            string newGradesAlert = base.GetElementTextById(GraderFeedbackResource.GraderFeedbackResource_MaximumScore_ID);
            try
            {
