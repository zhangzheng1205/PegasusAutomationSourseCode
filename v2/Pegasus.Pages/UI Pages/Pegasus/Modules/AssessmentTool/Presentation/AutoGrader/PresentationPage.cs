...
namespace Pegasus.Pages.UI_Pages.Pegasus.Modules.AssessmentTool.Presentation.AutoGrader
{
    public class PresentationPage : BasePage
    {
        ...
        public string GetDownloadFilesButtonText()
        {
            ...
            buttonText = base.GetElementTextByPartialLinkText(PresentationPageResource
                .PresentationPage_Page_DownloadButton_Title_Value);
        ...
        public void ClickSubmitButton()
        {
            ...
            base.SelectWindow(PresentationPageResource.
                      PresentationPage_Page_Title_Value);
            base.WaitForElement(By.Id(PresentationPageResource.PresentationPage_Page_Submit_Button_Id));
            IWebElement getSubmitButtonID = base.GetWebElementPropertiesById(PresentationPageResource.PresentationPage_Page_Submit_Button_Id);
        ...
        public string GetUploadCompletedFileButtonText()
        {
            ...
            base.SelectWindow(PresentationPageResource.
                                  PresentationPage_Page_Title_Value);
            base.WaitForElement(By.PartialLinkText(PresentationPageResource.PresentationPage_Page_UploadCompleteButton_Title_Value));
            buttonText2 = base.GetElementTextByPartialLinkText(PresentationPageResource.PresentationPage_Page_UploadCompleteButton_Title_Value);
            string f = buttonText2;
            logger.LogMethodExit("PresentationPage",
               "GetUploadCompletedFileButtonText",
               base.IsTakeScreenShotDuringEntryExit);
            return buttonText2;
        ...
        public Boolean ValidateTheMessageOnPopupPage(string message)
        {
            ...
            try
            {
                ...
                base.SelectWindow(PresentationPageResource.PresentationPage_Page_Title_Value);

                //Check the message excpected and obtained are same
                IsTrue = base.IsElementContainsTextById(PresentationPageResource.PresentationPage_Page_Table_Id_Locator, message);
            }
            //Exception Handling
            catch (Exception e)
            {
