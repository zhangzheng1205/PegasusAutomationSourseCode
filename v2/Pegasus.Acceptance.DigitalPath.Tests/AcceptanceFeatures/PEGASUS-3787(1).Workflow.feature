...
When I search "MasterLibrary" in workspace
...
When I search "DigitsAuthoredCourse" in workspace
...
When I verify the course "MasterLibrary" for AssignedToCopy state
