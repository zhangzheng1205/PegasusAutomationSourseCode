...
Then I should see the "DigitalPath" period configured in calendar successfully
...
And I click on Ok button in Assign pop up
Then I should be on the "Planner" page
And I should see the assigned asset "Topic 1 Test" under the period "DigitalPath" in calendar frame
...
And I click on Ok button in Assign pop up
Then I should be on the "Planner" page
And I should see the assigned asset "1-1 Homework" under the period "DigitalPath" in calendar frame
