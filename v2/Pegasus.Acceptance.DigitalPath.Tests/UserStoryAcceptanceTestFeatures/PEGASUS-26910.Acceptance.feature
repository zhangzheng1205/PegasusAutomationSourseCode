Feature: PEGASUS-26910
		As a demo account user
		I want to mangae demo user related usecases
		So that I would validate product associated with demo account

#Purpose: Product association with demo account
Scenario: Display of Multiple Welcome banner for Demo Teacher
...
And  I should see the display of 3 "DigitalPathDemo" Product branding images 
