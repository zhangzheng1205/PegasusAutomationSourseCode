...
And I should see the updated apply grade schema value "B" for Activity "Test"
When I "Sign Out" from the "NovaNETCsTeacher"
Then I should see the "Signed Out" message
...
And I "Sign Out" from the "NovaNETCsTeacher"
Then I should see the "Signed Out" message
...
And I search the "NovaNETCsStudent" in gradebook
Then I should see searched grade under activity column of submitted "Test" activity for "NovaNETCsStudent"
When I "Sign Out" from the "NovaNETCsTeacher"
Then I should see the "Signed Out" message
