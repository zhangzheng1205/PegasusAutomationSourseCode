    ...
    ContineoAcceptanceTestDefinitions
{
    ...
    public class RumbaLicensing : PegasusBaseTestFixture
    {
        ...
        /// <summary>
        /// Create Rumba Organizational Product Resource.
        /// </summary>
        ...
        /// <summary>
        /// Add the Rumba Product Id To Resource Id.
        /// </summary>
        ...
        public void AddRumbaResourceToRumbaProduct()
        {
            ...
            new ProductsAndResourcesPage().ClickOnProductsAndResourcesTab();
            //To add the product id to resource id
            new ProductsAndResourcesPage().AddProductIDToResourceID();
